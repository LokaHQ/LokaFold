...
#   # ----------------------------------
#   # Modified by Loka Team to map binding code for faster development
#   code_path = os.path.join(_ROOT_MOUNT_DIRECTORY, '/app/alphafold/alphafold/common')
#   mounts.append(types.Mount(target=code_path, source="/data/LokaFold/alphafold/common", type='bind'))
#   # ----------------------------------
