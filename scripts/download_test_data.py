...
# s3.download_file('alphafold-dbs-mirrors', 'bfd_metaclust_clu_complete_id30_c90_final_seq', 'bfd_metaclust_clu_complete_id30_c90_final_seq.sorted_opt')
# s3.download_file('alphafold-dbs-mirrors', 'mgy_clusters_2018_12.fa', 'mgy_clusters_2019_12.fa')
# s3.download_file('alphafold-dbs-mirrors', 'pdb70', 'pdb70.fa')
...
# s3.download_file('alphafold-dbs-mirrors', 'bfd-first_non_consensus_sequences.fasta', 'bfd-first_non_consensus_sequences.fasta')
...
s3 = boto3.client('s3')
s3.download_file('alphafold-dbs-mirrors', 'bfd_metaclust_clu_complete_id30_c90_final_seq', '/mnt/bfd_database_path/bfd_metaclust_clu_complete_id30_c90_final_seq.sorted_opt')
